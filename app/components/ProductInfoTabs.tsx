...
const PROSE =
  "product-info-prose text-base leading-relaxed text-[#347345] [&_h1]:font-heading! [&_h1]:text-3xl! [&_h1]:font-semibold [&_h1]:tracking-[-0.04em] [&_h1]:text-[#004817] [&_h2]:mt-8 [&_h2]:font-heading! [&_h2]:text-2xl! [&_h2]:font-semibold [&_h2]:tracking-[-0.04em] [&_h2]:text-[#004817] [&_h3]:mt-6 [&_h3]:font-heading! [&_h3]:text-xl! [&_h3]:font-semibold [&_h3]:text-[#004817] [&>p]:text-[#347345] [&>p+p]:mt-5 [&>ul]:mt-5 [&>ul]:flex [&>ul]:flex-col [&>ul]:gap-3 [&_li]:relative [&_li]:mb-0 [&_li]:pl-7 [&_li]:leading-relaxed [&_li]:text-[#347345] [&_li]:before:absolute [&_li]:before:left-0 [&_li]:before:top-[0.55em] [&_li]:before:size-2 [&_li]:before:rounded-full [&_li]:before:bg-[#00752d] [&_li]:before:content-[''] [&_a]:font-semibold [&_a]:text-[#00521d] [&_a]:underline [&_a]:underline-offset-4 [&_a]:transition-colors [&_a]:hover:text-[#00752d]";
  ...
  return (
    <section className="mt-12 rounded-[2rem] bg-[#effce9] p-6 sm:p-8 lg:mt-16 lg:p-12">
      <div
        ...
        className="flex w-full flex-col gap-1 rounded-[1.75rem] bg-white p-1 ring-1 ring-[#d6f3d0] sm:inline-flex sm:w-auto sm:flex-row sm:rounded-full"
      >
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`w-full shrink-0 rounded-full px-4 py-2.5 font-heading text-sm font-semibold transition-colors focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[#00521d] sm:w-auto sm:px-5 ${
                selected
